  ...
  get template() {
    return `
      <div class="pagination">
        <div class="pagination__previous" data-element="prev-page">
          <a class="pagination__item-link" href="#/previous">
            <img src="./images/icons/chevron-left.svg" alt="Previous">
          </a>
        </div>
        <div data-element="pagination-items" class="pagination__items">

        </div>
        <div class="pagination__next" data-element="next-page">
          <a class="pagination__item-link" href="#/next">
  ...
  getPaginationItems() {
    ...
    return pages
      .map((item) => {
        ...
        if (isActive) {
          return `
            <span class="pagination__item-current" data-page-number="${item}">${item}</span>
          `;
        } else {
          return `
            <a class="pagination__item-link" data-page-number="${item}" href="#/page/${item}">${item}</a>
          `;
        }
      })
      .join("");
